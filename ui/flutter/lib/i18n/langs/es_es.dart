const esES = {
  'es_ES': {
    ...
    'githubMirrorEnable': 'Habilitar espejo de GitHub',
    'githubMirrorDesc': 'Usar espejos para acelerar las descargas de contenido de GitHub',
    'githubMirrorType': 'Tipo de espejo',
    'githubMirrorUrl': 'URL del espejo',
    'githubMirrorUrlHint': 'Introducir URL del espejo',
    'notifyWhenNewVersion': 'Notificar cuando haya actualizaciones',
    'analyticsEnabled': 'Subir estadísticas',
    'analyticsEnabledDesc': 'Compartir datos de uso anónimos para ayudarnos a mejorar',
    'webhook': 'Webhook',
    'webhookEnable': 'Habilitar Webhook',
    'webhookDesc': 'Enviar notificaciones HTTP POST cuando las tareas se completen o fallen',
    'webhookUrlHint': 'Introducir URL del webhook',
    'webhookTest': 'Prueba',
    'webhookTestSuccess': 'Prueba de webhook exitosa',
    'webhookTestFail': 'Prueba de webhook fallida',
    'urlInvalid': 'Por favor ingrese una URL HTTP o HTTPS válida',
    'required': 'Este campo es obligatorio',
    'add': 'Agregar',
    'edit': 'Editar',
    'login': 'Iniciar sesión',
    'username_required': 'Por favor ingrese su nombre de usuario',
    'password_required': 'Por favor ingrese su contraseña',
    'login_success': 'Inicio de sesión exitoso',
    'login_failed': 'Inicio de sesión fallido, verifique su nombre de usuario y contraseña',
    'login_failed_network': 'Inicio de sesión fallido, verifique su conexión de red',
    'followSettings': 'Seguir configuración',
    'select': 'Seleccionar',
    'continue': 'Continuar',
    'pause': 'Pausa',
    'setAsDefaultBtClient': 'Establecer como cliente BT predeterminado',
    'name': 'Nombre',
    'size': 'Tamaño',
    'unknown': 'Desconocido',
    'fileSelectedCount': 'Archivos: ',
    'fileSelectedSize': 'Tamaño: ',
    'httpHeaderName': 'Nombre del encabezado',
    'httpHeaderValue': 'Valor del encabezado',
    'notifyDownloadComplete': 'Notificar cuando la descarga se complete',
    'downloadCompleteTitle': 'Descarga completada',
    'downloadCompleteBody': 'Archivo "@fileName" (@fileSize) ha sido descargado exitosamente',
    'downloadFailedTitle': 'Descarga fallida',
    'downloadFailedBody': 'Archivo "@fileName" no pudo descargar: @error',
  },
};
