const viVN = {
  'vi_VN': {
    ...
    'githubMirrorEnable': 'Bật GitHub Mirror',
    'githubMirrorDesc': 'Sử dụng mirror để tăng tốc độ tải nội dung GitHub',
    'githubMirrorType': 'Loại Mirror',
    'githubMirrorUrl': 'URL Mirror',
    'githubMirrorUrlHint': 'Nhập URL Mirror',
    'notifyWhenNewVersion': 'Thông báo khi có cập nhật',
    'analyticsEnabled': 'Tải lên thống kê',
    'analyticsEnabledDesc': 'Chia sẻ dữ liệu sử dụng ẩn danh để giúp chúng tôi cải thiện',
    'webhook': 'Webhook',
    'webhookEnable': 'Bật Webhook',
    'webhookDesc': 'Gửi thông báo HTTP POST khi tác vụ hoàn thành hoặc thất bại',
    'webhookUrlHint': 'Nhập URL webhook',
    'webhookTest': 'Kiểm tra',
    'webhookTestSuccess': 'Kiểm tra webhook thành công',
    'webhookTestFail': 'Kiểm tra webhook thất bại',
    'urlInvalid': 'Vui lòng nhập URL HTTP hoặc HTTPS hợp lệ',
    ...
    'login_failed_network': 'Đăng nhập thất bại, vui lòng kiểm tra kết nối mạng',
    'followSettings': 'Theo thiết lập',
    'select': 'Chọn',
    'continue': 'Tiếp tục',
    'pause': 'Tạm dừng',
    'setAsDefaultBtClient': 'Đặt làm máy khách BT mặc định',
    'seedConfig': 'Cấu hình seed',
    'seedKeep': 'Tiếp tục seed cho đến khi ngừng thủ công',
    'seedRatio': 'Tỷ lệ seed',
    'seedTime': 'Thời gian seed (phút)',
    'taskDetail': 'Chi tiết nhiệm vụ',
    'taskName': 'Tên nhiệm vụ',
    'taskUrl': 'URL nhiệm vụ',
    'downloadPath': 'Đường dẫn tải về',
    'name': 'Tên',
    'size': 'Kích thước',
    'unknown': 'Không xác định',
    'fileSelectedCount': 'Tệp: ',
    'fileSelectedSize': 'Kích thước: ',
    'httpHeaderName': 'Tên tiêu đề',
    'httpHeaderValue': 'Giá trị tiêu đề',
    'show': 'Hiển thị',
    'noProxy': 'Không có Proxy',
    'systemProxy': 'Proxy hệ thống',
    'customProxy': 'Proxy tùy chỉnh',
    'notifyDownloadComplete': 'Thông báo khi tải về hoàn tất',
    'downloadCompleteTitle': 'Tải về hoàn tất',
    'downloadCompleteBody': 'Tệp "@fileName" (@fileSize) đã được tải về thành công',
    'downloadFailedTitle': 'Tải về thất bại',
    'downloadFailedBody': 'Tệp "@fileName" tải về thất bại: @error',
  },
};
