const ruRU = {
  'ru_RU': {
    ...
    'githubMirror': 'GitHub зеркало',
    'githubMirrorEnable': 'Включить GitHub зеркало',
    'githubMirrorDesc': 'Использовать зеркала для ускорения загрузки содержимого GitHub',
    'githubMirrorType': 'Тип зеркала',
    'githubMirrorUrl': 'URL зеркала',
    'githubMirrorUrlHint': 'Введите URL зеркала',
    'notifyWhenNewVersion': 'Уведомлять о наличии обновлений',
    'analyticsEnabled': 'Загружать статистику',
    'analyticsEnabledDesc': 'Делиться анонимными данными об использовании, чтобы помочь нам улучшить',
    'webhook': 'Webhook',
    'webhookEnable': 'Включить Webhook',
    'webhookDesc': 'Отправлять уведомления HTTP POST при завершении или сбое задач',
    'webhookUrlHint': 'Введите URL Webhook',
    'webhookTest': 'Тест',
    'webhookTestSuccess': 'Тест Webhook прошел успешно',
    'webhookTestFail': 'Тест Webhook не удался',
    'urlInvalid': 'Пожалуйста, введите действительный HTTP или HTTPS URL',
    ...
    'login_failed': 'Не удалось войти, проверьте имя пользователя и пароль',
    'login_failed_network': 'Не удалось войти, проверьте подключение к сети',
    'notifyDownloadComplete': 'Уведомлять о завершении загрузки',
    'downloadCompleteTitle': 'Загрузка завершена',
    'downloadCompleteBody': 'Файл "@fileName" (@fileSize) успешно загружен',
    'downloadFailedTitle': 'Загрузка не удалась',
    'downloadFailedBody': 'Не удалось загрузить файл "@fileName": @error',
  }
};
