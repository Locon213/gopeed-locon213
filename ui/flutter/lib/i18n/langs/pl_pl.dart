const plPL = {
  'pl_PL': {
    ...
    'githubMirror': 'Lustro GitHub',
    'githubMirrorEnable': 'Włącz lustro GitHub',
    'githubMirrorDesc': 'Użyj lustra do przyspieszenia pobierania zawartości GitHub',
    'githubMirrorType': 'Typ lustra',
    'githubMirrorUrl': 'Adres lustra',
    'githubMirrorUrlHint': 'Wprowadź adres lustra',
    'notifyWhenNewVersion': 'Powiadom o aktualizacjach',
    'analyticsEnabled': 'Prześlij statystyki',
    'analyticsEnabledDesc': 'Udostępnij anonimowe dane użytkowania, aby pomóc nam w ulepszaniu',
    'webhook': 'Webhook',
    'webhookEnable': 'Włącz Webhook',
    'webhookDesc': 'Wysyłaj powiadomienia HTTP POST, gdy zadania są zakończone lub nieudane',
    'webhookUrlHint': 'Wprowadź adres webhooka',
    'webhookTest': 'Test',
    'webhookTestSuccess': 'Test webhooka zakończony sukcesem',
    'webhookTestFail': 'Test webhooka nieudany',
    'urlInvalid': 'Wprowadź poprawny adres HTTP lub HTTPS',
    ...
    'login_failed': 'Logowanie nieudane, sprawdź nazwę użytkownika i hasło',
    'login_failed_network': 'Logowanie nieudane, sprawdź połączenie sieciowe',
    'followSettings': 'Postępuj zgodnie z ustawieniami',
    'select': 'Wybierz',
    'continue': 'Kontynuuj',
    'pause': 'Wstrzymaj',
    'setAsDefaultBtClient': 'Ustaw jako domyślnego klienta BT',
    'seedConfig': 'Konfiguracja seedowania',
    'seedKeep': 'Kontynuuj seedowanie do momentu ręcznego zatrzymania',
    'seedRatio': 'Współczynnik seedowania',
    'seedTime': 'Czas seedowania (minuty)',
    ...
    'size': 'Rozmiar',
    'unknown': 'Nieznany',
    'fileSelectedCount': 'Pliki: ',
    'fileSelectedSize': 'Rozmiar: ',
    'httpHeaderName': 'Nazwa nagłówka',
    'httpHeaderValue': 'Wartość nagłówka',
    'autoStartTasks': 'Automatycznie uruchamiaj nieukończone zadania przy starcie',
    'notifyDownloadComplete': 'Powiadom o zakończeniu pobierania',
    'downloadCompleteTitle': 'Pobieranie zakończone',
    'downloadCompleteBody': 'Plik "@fileName" (@fileSize) został pomyślnie pobrany',
    'downloadFailedTitle': 'Pobieranie nieudane',
    'downloadFailedBody': 'Plik "@fileName" nie został pobrany: @error',
  },
};
