const trTR = {
  'tr_TR': {
    ...
    'githubMirrorDesc': 'GitHub içerik indirmelerini hızlandırmak için yansıyı kullan',
    ...
    'analyticsEnabledDesc': 'Geliştirmemize yardımcı olmak için anonim kullanım verilerini paylaş',
    'webhook': 'Webhook',
    'webhookEnable': 'Webhook Etkinleştir',
    'webhookDesc': 'Görevler tamamlandığında veya başarısız olduğunda HTTP POST bildirimleri gönder',
    ...
    'login_failed_network': 'Giriş başarısız, ağ bağlantınızı kontrol edin',
    'autoStartTasks': 'Başlangıçta eksik görevleri otomatik başlat',
    'notifyDownloadComplete': 'İndirme tamamlandığında bildir',
    'downloadCompleteTitle': 'İndirme Tamamlandı',
    'downloadCompleteBody': '"@fileName" (@fileSize) dosyası başarıyla indirildi',
    'downloadFailedTitle': 'İndirme Başarısız',
    'downloadFailedBody': '"@fileName" dosyası indirilemedi: @error',
  },
};
