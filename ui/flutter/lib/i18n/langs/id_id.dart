const idID = {
  'id_ID': {
    ...
    'githubMirror': 'Mirror GitHub',
    'githubMirrorEnable': 'Aktifkan Mirror GitHub',
    'githubMirrorDesc': 'Gunakan mirror untuk mempercepat unduhan konten GitHub',
    'githubMirrorType': 'Jenis Mirror',
    'githubMirrorUrl': 'URL Mirror',
    'githubMirrorUrlHint': 'Masukkan URL mirror',
    'notifyWhenNewVersion': 'Beritahu tentang pembaruan',
    'analyticsEnabled': 'Unggah Statistik',
    'analyticsEnabledDesc': 'Bagikan data penggunaan anonim untuk membantu kami meningkatkan',
    'webhook': 'Webhook',
    'webhookEnable': 'Aktifkan Webhook',
    'webhookDesc': 'Kirim notifikasi HTTP POST ketika tugas selesai atau gagal',
    'webhookUrlHint': 'Masukkan URL webhook',
    'webhookTest': 'Uji',
    'webhookTestSuccess': 'Uji webhook berhasil',
    'webhookTestFail': 'Uji webhook gagal',
    'urlInvalid': 'Silakan masukkan URL HTTP atau HTTPS yang valid',
    'required': 'Bidang ini wajib diisi',
    'add': 'Tambah',
    'edit': 'Edit',
    'login': 'Masuk',
    'username_required': 'Silakan masukkan nama pengguna Anda',
    'password_required': 'Silakan masukkan kata sandi Anda',
    'login_success': 'Berhasil masuk',
    'login_failed': 'Gagal masuk, periksa nama pengguna dan kata sandi Anda',
    'login_failed_network': 'Gagal masuk, periksa koneksi jaringan Anda',
    'continue': 'Lanjutkan',
    'pause': 'Jeda',
    'setAsDefaultBtClient': 'Atur sebagai klien BT bawaan',
    'name': 'Nama',
    'size': 'Ukuran',
    'unknown': 'Tidak diketahui',
    'fileSelectedCount': 'File: ',
    'fileSelectedSize': 'Ukuran: ',
    'httpHeaderName': 'Nama Header',
    'httpHeaderValue': 'Nilai Header',
    'notifyDownloadComplete': 'Beritahu saat unduhan selesai',
    'downloadCompleteTitle': 'Unduhan Selesai',
    'downloadCompleteBody': 'File "@fileName" (@fileSize) telah berhasil diunduh',
    'downloadFailedTitle': 'Unduhan Gagal',
    'downloadFailedBody': 'File "@fileName" gagal diunduh: @error',
  },
};
