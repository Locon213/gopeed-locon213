const ptBR = {
  'pt_BR': {
    ...
    'githubMirror': 'Espelho do GitHub',
    'githubMirrorEnable': 'Ativar espelho do GitHub',
    'githubMirrorDesc': 'Usar espelhos para acelerar downloads de conteúdo do GitHub',
    'githubMirrorType': 'Tipo de espelho',
    'githubMirrorUrl': 'URL do espelho',
    'githubMirrorUrlHint': 'Digite a URL do espelho',
    'notifyWhenNewVersion': 'Notificar sobre atualizações',
    'analyticsEnabled': 'Enviar Estatísticas',
    'analyticsEnabledDesc': 'Compartilhar dados de uso anônimos para nos ajudar a melhorar',
    'webhook': 'Webhook',
    'webhookEnable': 'Ativar Webhook',
    'webhookDesc': 'Enviar notificações HTTP POST quando tarefas forem concluídas ou falharem',
    'webhookUrlHint': 'Digite a URL do webhook',
    'webhookTest': 'Teste',
    'webhookTestSuccess': 'Teste do webhook bem-sucedido',
    'webhookTestFail': 'Falha no teste do webhook',
    'urlInvalid': 'Por favor, digite uma URL HTTP ou HTTPS válida',
    'required': 'Este campo é obrigatório',
    'add': 'Adicionar',
    'edit': 'Editar',
    'login': 'Entrar',
    'username_required': 'Por favor, digite seu nome de usuário',
    'password_required': 'Por favor, digite sua senha',
    'login_success': 'Login realizado com sucesso',
    'login_failed': 'Falha no login, verifique seu nome de usuário e senha',
    'login_failed_network': 'Falha no login, verifique sua conexão de rede',
    'autoStartTasks': 'Iniciar automaticamente tarefas incompletas na inicialização',
    'notifyDownloadComplete': 'Notificar quando download for concluído',
    'downloadCompleteTitle': 'Download Concluído',
    'downloadCompleteBody': 'Arquivo "@fileName" (@fileSize) foi baixado com sucesso',
    'downloadFailedTitle': 'Download Falhou',
    'downloadFailedBody': 'Arquivo "@fileName" falhou ao baixar: @error',
  },
};
