const frFR = {
  'fr_FR': {
    ...
    'githubMirror': 'Miroir GitHub',
    'githubMirrorEnable': 'Activer le miroir GitHub',
    'githubMirrorDesc': 'Utiliser des miroirs pour accélérer les téléchargements de contenu GitHub',
    'githubMirrorType': 'Type de miroir',
    'githubMirrorUrl': 'URL du miroir',
    'githubMirrorUrlHint': 'Entrez l\'URL du miroir',
    'notifyWhenNewVersion': 'Notifier lorsqu\'une nouvelle version est disponible',
    'analyticsEnabled': 'Envoyer les statistiques',
    'analyticsEnabledDesc': 'Partager des données d\'utilisation anonymes pour nous aider à améliorer',
    'webhook': 'Webhook',
    'webhookEnable': 'Activer le Webhook',
    'webhookDesc': 'Envoyer des notifications HTTP POST lorsque les tâches sont terminées ou échouent',
    'webhookUrlHint': 'Entrez l\'URL du webhook',
    'webhookTest': 'Tester',
    'webhookTestSuccess': 'Test du webhook réussi',
    'webhookTestFail': 'Échec du test du webhook',
    'urlInvalid': 'Veuillez entrer une URL HTTP ou HTTPS valide',
    'required': 'Ce champ est requis',
    'add': 'Ajouter',
    'edit': 'Modifier',
    'login': 'Se connecter',
    'username_required': 'Veuillez entrer votre nom d\'utilisateur',
    ...
    'login_failed_network': 'Échec de la connexion, veuillez vérifier votre connexion réseau',
    'followSettings': 'Suivre les paramètres',
    'select': 'Sélectionner',
    'continue': 'Continuer',
    'pause': 'Suspendre',
    'setAsDefaultBtClient': 'Définir comme client BT par défaut',
    'seedConfig': 'Configuration du partage',
    'seedKeep': 'Continuer à partager jusqu\'à arrêt manuel',
    'seedRatio': 'Ratio de partage',
    'seedTime': 'Durée de partage (minutes)',
    ...
    'size': 'Taille',
    'unknown': 'Inconnu',
    'fileSelectedCount': 'Fichiers : ',
    'fileSelectedSize': 'Taille : ',
    'httpHeaderName': 'Nom de l\'en-tête',
    'httpHeaderValue': 'Valeur de l\'en-tête',
    'notifyDownloadComplete': 'Notifier lorsque le téléchargement est terminé',
    'downloadCompleteTitle': 'Téléchargement terminé',
    'downloadCompleteBody': 'Le fichier "@fileName" (@fileSize) a été téléchargé avec succès',
    'downloadFailedTitle': 'Échec du téléchargement',
    'downloadFailedBody': 'Le fichier "@fileName" n\'a pas pu être téléchargé : @error',
  },
};
